    ...
    for (char x = 0; x < 8; x++) {
        for (char y = 0; y < 8; y++) {
            switch (board[y][x]) {
                ...
                case 'Q': whitePieces[4]++; break;
                case 'K': whitePieces[5]++; break;

                case 'p': blackPieces[0]++; break;
                case 'r': blackPieces[1]++; break;
                case 'n': blackPieces[2]++; break;
                case 'b': blackPieces[3]++; break;
                case 'q': blackPieces[4]++; break;
                case 'k': blackPieces[5]++; break;
            }
        }
    }
